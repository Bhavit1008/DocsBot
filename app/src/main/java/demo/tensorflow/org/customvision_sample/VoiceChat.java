...
public class VoiceChat extends AppCompatActivity {
    ...
    public String GetText(String query) throws UnsupportedEncodingException {
        ...
        try {
            ...
            conn.setRequestProperty("Authorization", "Bearer 03b93c1becb24ebe987ea9761691d582"); //b0f0645503494fe9bc0c4636d6145a24
    ...
    class RetrieveFeedTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... voids) {
            ...
            try {
                ...
                e.printStackTrace();
                Log.d("karma is a bitch", "Exception occurred " + e);
            }
